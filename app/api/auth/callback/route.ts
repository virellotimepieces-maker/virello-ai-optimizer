...
export async function GET(request: NextRequest) {
  try {
    ...
    const savedState =
      request.cookies.get("virello_shopify_oauth_state")?.value || "";
    ...
    result.cookies.delete("virello_shopify_oauth_state");
    result.cookies.delete("virello_shopify_oauth_shop");
